$(document).ready(function() { //perform actions when DOM is ready
 ...
 $('#pictures2').append('<div id="loader"></div>'); //append the loader div, it overlaps all pictures
  ...
  function swapSecondLast(isFirst) {
    ...
    $('.pic2 img').each(function() { //process each image
    ...
    return swapSecondLast(true); //swap first image to last position
  });
  
  $('#prev2 a').click(function() {
    return swapSecondLast(false); //swap last image to first position
  });
});