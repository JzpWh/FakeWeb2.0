$(document).ready(function() { //perform actions when DOM is ready
  ...
  $('#pictures1').append('<div id="loader"></div>'); //append the loader div, it overlaps all pictures
  
  $('#pictures1 img').each(function() { //set the initial z-index's
...
function swapFirstLast(isFirst) {
    ...
    $('.pic1 img').each(function() { //process each image
