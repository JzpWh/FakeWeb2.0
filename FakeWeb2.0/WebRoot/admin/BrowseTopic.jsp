...
<div id="sidebar">
            ...
            <ul>
                ...
                <li class="submenu ">
                    ...
                    <ul>
                        <li class="active"><a href="BrowseAdmin.jsp">浏览管理员</a></li>
                                ...
                                <div class="widget-content nopadding">
                                    <table class="table table-bordered data-table">
                                        ...
                                        <td class="taskOptions">
                                            <a href="topic.jsp" class="tip-top"  data-original-title="topic" ><i class="icon-ok"></i>
                                            </a>
                                        </td>
                                         <td class="taskOptions">
                                          <a href="#" class="tip-top" ><i class="icon-remove"></i></a></td>
