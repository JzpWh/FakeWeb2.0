				...
				<li class="submenu open">
					<a href="#">
                 	...
                 	<ul>
						...
						<li class="active"><a href="ResearchBarberShop.jsp">查找理发店</a></li>
									...
									<form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" />
                                       <div class="control-group" id="control-two">
                                        ...
                                        <label class="checkbox inline">   <span>查找方式：</span>
                                          <input type="checkbox" id="inlineCheckbox1" value="name"> 理发店名称
                                            </label>
                                        <label class="checkbox inline">
                                          <input type="checkbox" id="inlineCheckbox2" value="address">理发店地址
                                        </label>
