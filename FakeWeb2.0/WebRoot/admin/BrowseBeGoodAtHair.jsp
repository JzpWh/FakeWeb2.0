	...
	<body>
			...
			<ul>
				...
				<li class="submenu open">
					<a href="#">
						...
						<span class="label">2</span></a>
					<ul>
						<li class="active"><a href="BrowseBeGoodAtHair.jsp">浏览擅长发型</a></li>
        ...
        <div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="current">最擅长发型管理</a>
                <a href="#" class="current">浏览最擅长发型</a>
			</div>
            <!--  面包屑导航stop-->
							...
							<div class="widget-content ">
								<div class="alert alert-block">
									<a class="close" data-dismiss="alert" href="#">×</a>
                                     <h4 style="position:relative;left:100px;top:40px;">卷发</h4>
                                     <p style="position:relative;left:100px;top:50px;">一个看似简单的梨花甜美风，清新脱俗，棕黄色象征聪慧，乐观，柔和快乐，每个人的风格不同，气质不同，中长发也能让那些正在犹豫的人做出<br>更好的选择，这个发型也可以使人拥有自信和希望，小脸女生，大脸女生......都很适合。</p>
                                 
									<img src="img/001.png"  class="img-polaroid"  style="margin-top:-30px;" class="pull-left">
                                 <button class="btn btn-warning pull-right" style="margin-top:40px;" type="button" >修改</button>
								</div>
								<div class="alert alert-success alert-block">
									...
									<img src="img/001.png"  class="img-polaroid"  style="margin-top:-30px;" class="pull-left">
                                      <button class="btn btn-success pull-right" style="margin-top:40px;" type="button" >修改</button>
								</div>
                                ...
                                <a class="close" data-dismiss="alert" href="#">×</a>
									...
									<img src="img/001.png"  class="img-polaroid"  style="margin-top:-30px;" class="pull-left">
								   <button class="btn btn-info pull-right" style="margin-top:40px;" type="button" >修改</button>
                                </div>
								<div class="alert alert-error alert-block">
									...
									<img src="../img/001.png"  class="img-polaroid"  style="margin-top:-30px;" class="pull-left">
                                    <button class="btn btn-danger pull-right" style="margin-top:40px;" type="button" >修改</button>
								</div>
