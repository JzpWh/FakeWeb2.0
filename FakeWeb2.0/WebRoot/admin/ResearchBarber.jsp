	...
	<body>
			...
			<ul>
				...
				<li class="submenu open">
                   ...
                   <ul>
						...
						<li class="active"><a href="ResearchBarber.jsp">查找发型师</a></li>
					</ul>
                </li>
                ...
                <li class="submenu">
                	<a href="#">
                        ...
                        <span class="label">2</span></a>
                     <ul>
						<li class="active"><a href="BrowseCustomer.jsp">浏览消费者</a></li>
        ...
        <div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="current">发型师管理</a>
                <a href="#" class="current">查找发型师</a>
			</div>
            <!--  面包屑导航stop-->
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
                                    ...
                                    <div class="control-group" id="control-two">
                                        ...
                                        <label class="checkbox inline"> <span>查找方式：</span>
                                          <input type="checkbox" id="inlineCheckbox1" value="name"> 姓名
                                            </label>
                                        <label class="checkbox inline">
                                          <input type="checkbox" id="inlineCheckbox2" value="department">地址
                                        </label>
                                        <label class="checkbox inline">
                                          <input type="checkbox" id="inlineCheckbox3" value="city"> 手机号
                                        </label>
                                    </div>
                                    </form>
                                    <hr>
                                              ...
                                              <div class="row-fluid">
                                                ...
                                                <div class="span10">
                                                  <div style="margin-left:20px;">
                                                    ...
                                                    <p>性别：<span>男</span></p>
                                                     <p>注册手机号：<span>121109786</span></p>
                                                    <p>年龄：<span>18</span></p>
                                                     <p>所属店铺：<span>港仔</span></p>
                                                     
                                                      <p>星级评价：<span>未知</span></p>
                                                      <p>评价：<span>未知</span></p>
