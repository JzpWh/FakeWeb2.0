...
<script type="text/javascript">
	function confirmDelete() {
		var fdel = window.confirm("是否确定删除该消费者？ ");
		if (fdel) {
			return true;
		} else {
			return false;
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li class="submenu "><a href="#"> <i class="icon icon-th"></i>
					<span>发型师管理</span> <span class="label">2</span></a>
				<ul>
					<li class="active"><a href="BrowseBarber.jsp">浏览发型师</a></li>
					<li><a href="ResearchBarber.jsp">查找发型师</a></li>
				</ul></li>

			<li class="submenu open"><a href="#"> <i
					class="icon icon-pencil"></i> <span>消费者管理</span> <span
					class="label">2</span></a>
				<ul>
					<li><a href="admin/customer_browseCustomer.action">浏览消费者</a></li>
	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="#" title="Go to Home" class="tip-bottom"><i
				class="icon-home"></i> 首页</a> <a href="#" class="current">消费者管理</a> <a
				href="#" class="current">浏览消费者</a>
		</div>
		<!--  面包屑导航stop-->
								...
								<table class="table">
									...
									<tbody>
										<s:iterator value="#CustomerList" status="status">
											<tr class="info">
												<td>${CName}</td>
												<td><s:if test="CSex">男</s:if> <s:else>女</s:else></td>
												<td>${CPhone}</td>
												<td>${CAddress}</td>
												<td>${BCreatetime}</td>
												...
												<td class="taskOptions" ><s:a
														action="customer_deleteCustomer?CId=%{CId}"
