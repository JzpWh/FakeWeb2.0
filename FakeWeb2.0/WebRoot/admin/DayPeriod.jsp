...
<html lang="en">
	...
	<body>
			...
			<ul>
				...
				<li class="submenu">
					<a href="#">
						...
						<span class="label">2</span></a>
					<ul>
						<li><a href="BrowseBeGootAtHair.jsp">浏览擅长发型</a></li>
				...
				<li class="submenu open">
					...
					<ul>
						...
						<li class="active"><a href="HourPeriod.jsp">时时段分析</a></li>
        ...
        <div id="content">
			...
			<div id="breadcrumb">
				<a href="index.jsp" titjspGo to Home" class="tip-bottom"><i class="icon-home"></i>首页</a>
				<a href="#" class="current">统计</a>
                <a href="#" class="current">时时段分析</a>
			</div>
            <!--  面包屑导航stop-->
