							...
							<div class="widget-content nopadding">
                                    ...
                                    <div class="control-group" id="control-two">
                                        ...
                                        <label class="checkbox inline"> <span>查找方式：</span>
                                          <input type="checkbox" id="inlineCheckbox1" value="name"> 发表者
                                            </label>
                                        <label class="checkbox inline">
                                          <input type="checkbox" id="inlineCheckbox2" value="department">关键字
                                        </label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <tbody>
                                           <tr class="success">
                                               ...
                                               <a href="ViewTopic.jsp" class="tip-top" data-original-title="topic" ><i class="icon-ok"></i></a>
                                               </td>
                                                <td class="taskOptions"> 
                                         ...
                                         <tr class="warning">
                                              <td>Tony</td>
                                               ...
                                               <td>港仔</td>
                                                <td class="taskOptions">
                                               <a href="topic.jsp" class="tip-top" data-original-title="topic" ><i class="icon-ok"></i></a>
                                               </td>
                                               <td class="taskOptions"> 
                                                  <a href="" class="tip-top" data-original-title="Delete"><i class="icon-remove"></i></a>
                                               </td>
